...
const Navbar = () => {
  ...
  return (
    <header className="bg-base-100 border-b border-base-300 fixed w-full
    top-0 z-40 backdrop-blur-lg bg-base-100/80 shadow-md">
      ...
      <Link to='/settings'
      className="btn btn-sm gap-2transition-colors"
      >
