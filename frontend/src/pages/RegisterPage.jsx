...
return true
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 mt-6 lg:mt-0">
     ...
     subtitle="Connect with friends and family, share your thoughts and ideas, and be part of a vibrant online community."
     />     
